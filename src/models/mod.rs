pub mod tuples {
    ...
    // Addition
    impl<'a, 'b> std::ops::Add<&'b Tuple> for &'a Tuple {
        type Output = Tuple;
    ...
    // Subtraction
    impl<'a, 'b> std::ops::Sub<&'b Tuple> for &'a Tuple {
        type Output = Tuple;
    ...
    // Negate
    impl<'a> std::ops::Neg for &'a Tuple {
        type Output = Tuple;
    ...
    // Multiply by number
    impl<'a> std::ops::Mul<f64> for &'a Tuple {
        type Output = Tuple;
    ...
    // Divide by number
    impl<'a> std::ops::Div<f64> for &'a Tuple {
        type Output = Tuple;
    ...
    // Cross product
    impl<'a, 'b> std::ops::Mul<&'b Tuple> for &'a Tuple {
        type Output = Tuple;
